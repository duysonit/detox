...
const CounterScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.container} forceInset={{ top: 'always' }}>
      <View accessibilityLabel='waterCounterLabel' testID='waterButtonText'>
        <CounterButton
          text="Water Counter"
          onPress={() => {
      ...
      <View accessibilityLabel='electricityCounterLabel' testID='electricityCounterButton'>
        <CounterButton
          ...
          counter={counter_2}
          counterTestId ="electricity"

        />
      </View>
      <View accessibilityLabel='gasCounterLabel' testID='gasCounterButton'>
        <CounterButton
          text="Gas Counter"
          onPress={() => {
      ...
      <View accessibilityLabel='broadbandCounterLabel' testID='broadbandCounterButton'>
        <CounterButton
