...
class CitiesPage {
    get citiesHeader() {
        return element(by.id("citiesHeaders"));
    }
    get citiesBackground() {
        // return element(by.id("citiesBackground"));
    ...
    get usacanadaBackground() {
        ...
        // return by.id("imageBackground-usa/canada");
    ...
    get asiaBackground() {
        ...
        // return by.id("imageBackground-asia");
