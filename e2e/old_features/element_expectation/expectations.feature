Feature: Element expectations
    ...
    Scenario: I can expect elements to be visible or not to be visible
    ...
    Scenario: I can expect elements to be exist or not to be exist
        Given I tap on the 'Cities' section
        When I verify that the first image of the asia exist
