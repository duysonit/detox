...
class BaseData {
    ...
    getSurname(memberNumber) {
        switch (memberNumber) {
            ...
            default:
                assert.fail(`The entered ${memberNumber} is an invalid number for Member Surname`);
        }
    }
    ...
    getStartDate(memberNumber) {
        switch (memberNumber) {
            ...
            default:
                assert.fail(`The entered ${memberNumber} is an invalid number for Member Start Date`);
        }
    }
